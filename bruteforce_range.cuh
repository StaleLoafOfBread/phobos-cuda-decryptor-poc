...
const int MAX_PERFCOUNTER_SECOND_CALL_TICKS_DIFF = 1500;
const int PERFCOUNTER_SECOND_CALL_TICKS_KEYSPACE = (MAX_PERFCOUNTER_SECOND_CALL_TICKS_DIFF - MIN_PERFCOUNTER_SECOND_CALL_TICKS_DIFF) + 1;
